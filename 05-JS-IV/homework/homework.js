...
function agregarAmigo (usuario, nuevoAmigo) {
  ...
  // Tu código:
  litas=[usuario['amigos']]
  litas.push("Shay")
  usuario['amigos']=litas;
  return usuario;
}
...
function sumarLikesDeUsuario (usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  //TODO Usuario es un objeto
  //TODO posts es un array
  //TODO post es un  objetos
  //TODO post have likes(int)
  cant=0;
  for (i=0;i<usuario['posts'].length;i++){
    cant = cant +usuario['posts'][i]['likes'];
  }
  return cant;
